...
router.post('/create', (req, res) => {
  ...
  db.query(queryString, [customer_id, service_id, employee_id, scheduled, description, status], (err, results, field) => {
      if (err) {
...
router.post("/:order_id/edit", (req, res) => {
  ...
  console.log(description);
	...
	db.query(queryString, [ customer_id, service_id, employee_id, scheduled, description, status, order_id, customer_id, service_id], (err, rows, fields) => {
		if (err) {
